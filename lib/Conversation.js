...
class Conversation extends Chat {
  ...
  ask (question, callbacks, options) {
    return new Promise((resolve, reject) => {
      ...
      this.listeningAnswer = resolve
      this.listeningReject = reject
  ...
  respond (payload, data) {
    ...
    this.listeningReject('Unexpected end of conversation')
